...
As an example, if we have 3 \mycode{short} variables, a, b, and c, and want store the sum of b and c in a, we need to insert a cast to avoid errors from the Java compiler:
