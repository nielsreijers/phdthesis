...
\newcommand{\tblhighlight}[0] {\cellcolor{yellow!45}}
...
%TODO: global check if \item starts with capital and ends in a full stop
%TODO: find different word for "unfair" optimisations

%TODO: discuss with prof Shih (1) include unfair optimisations? (2) include SensorScheme in conclusion table?
