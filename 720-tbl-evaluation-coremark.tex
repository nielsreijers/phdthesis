...
\label{tbl-coremark-manual-optimisation}
    ...
    \makebox[5mm]{} \scriptsize manually inline small methods             & \scriptsize   0.1          & \scriptsize   (+1\%)       & \scriptsize     -37        & \scriptsize  (-75\%)             & \scriptsize   -16.7        & \scriptsize    (-93\%) & \scriptsize  -53.8         & \scriptsize  (-63\%) \\
    \makebox[5mm]{} \scriptsize use short array index variables           & \scriptsize  -0.1          & \scriptsize   (-1\%)       & \scriptsize  -104.8        & \scriptsize (-213\%)             & \scriptsize       0        & \scriptsize      (0\%) & \scriptsize -104.7         & \scriptsize (-123\%) \\
