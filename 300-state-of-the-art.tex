...
\caption[Darjeeling infusion process]{Darjeeling infusion process, taken from \cite{Brouwers:2009cj}}
...
\caption[Darjeeling split operand stack]{Darjeeling split operand stack, taken from \cite{Brouwers:2009cj}}
...
\begin{table}
\caption{Example of Ellul's AOT translation of \mycode{c=a+b;}}
...
Ellul's approach improves performance considerably compared to the interpreters, but using the standard \mybench{CoreMark} benchmark \cite{coremark}, it still generates code that is still up to 9x slower than optimised native C. The average slowdown found in our benchmarks was 5.4x.
