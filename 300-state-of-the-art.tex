...
Ellul's approach improves performance considerably compared to the interpreters, but using the standard \mybench{CoreMark} benchmark \cite{coremark}, it generates code that is still up to 9.1x slower than optimised native C.
