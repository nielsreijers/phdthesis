...
%TODO: add section on "Lightweight Module Isolation for Sensor Nodes" paper, eventough it's not implemented and has no evaluation. there's only 3 papers on the topic, so we might as well cite it.
