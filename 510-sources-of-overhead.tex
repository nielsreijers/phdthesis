...
The \mycode{javac} compiler simply compiles the code 'as is'. For example, the loop 
...
In Table \ref{tbl-basic-translation}, it is clear that the \mycode{SLOAD_0} instruction at label 5 is unnecessary since the value is already in R1.
