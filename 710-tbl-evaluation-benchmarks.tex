...
\label{tbl-benchmarks}
    ...
    \midrule
    \midrule
    \emph{Bubble sort}       & Darjeeling sources \cite{darjeelingsource}                                                                 & single function  & no             & \cite{Brouwers:2009cj, Ellul:2012thesis} \\
    ...
    \emph{Binary search}     & TakaTuka sources \cite{takatukasource}                                                                     & single function  & no             & \cite{Ellul:2012thesis}                  \\
