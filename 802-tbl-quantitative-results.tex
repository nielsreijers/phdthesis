...
\label{tbl-quantitative-results}
    ...
    \ref{sec-const-data}       & Size of constant data                &             &             &              &             &        &       200 &         2,048 &         &            51 &                &                   20,560 &           &            \\
                               & Constant array RAM overhead          &             &             &              &             &        &       208 &  \tblhl 2,056 &         &            67 &                &           \tblhl too big &           &            \\
                               & Constant array flash overhead        &             &             &              &             &        &     1,998 & \tblhl 26,714 &         &           930 &                &           \tblhl too big &           &            \\
\\
...
\\
    ...
    \begin{tablenotes}
        ...
        \item[b] Actual amount of memory used. \mybench{CoreMark}'s C version allocates 2047 bytes, but the remaining space is not used.
        \item[c] After replacing \mybench{MoteTrack}'s 2-byte RSSI array with two variables.
