...
%TODO add a picture somewhere showing there's no OS, but the VM runs directly on the hardware.
...
% TODO: clarify two terms: compile-time (javac/proguard/infuser) and translation-time (the VM)
