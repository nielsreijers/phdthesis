...
\begin{itemize}
	...
	\item \mycode{PUTFIELD\_A\_FIXED} and \mycode{GETFIELD\_A\_FIXED} are used to access an object's reference fields when the offset is known at compile time. The offset ia always known at compile time for integer fields.
