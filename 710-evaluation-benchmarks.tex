...
%TODO Rewrite this. array processing is likely to be performance sensitive. maybe we should say something here about the lack of cache lines, branch prediction, etc?
