...
In the rest of the evaluation, the manually optimised code is used for all benchmarks. For \mybench{CoreMark} this includes the two non-automatic optimisations. The optimisation to avoid repeatly creating temporary objects was also applied to the \mybench{LEC} and \mybench{MoteTrack} benchmarks.
