...
In the rest of the evaluation we use the \mybench{CoreMark} version without these two optimisations.

%TODO: discuss with prof Shih, should we use these anyway? since they're also used for LEC, MoteTrack and Heat detection?
