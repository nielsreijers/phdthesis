...
% Our VM (unsafe) & Yes         & No                 & 18 to 165\% slower    & -17 to 121\% larger    \\
% Our VM (safe)   & Yes         & Yes                & 22 to 247\% slower    & -16 to 125\% larger    \\
Our VM (unsafe) & Yes         & No                 & 71\% slower           & 78\% larger            \\ % avg
Our VM (safe)   & Yes         & Yes                & 105\% slower          & 82\% larger            \\ % avg
\bottomrule
\end{tabular}
\begin{tablenotes}
