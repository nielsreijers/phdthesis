...
% TODO: UDPATE THIS AGAN, since the tiny fix in lightweight methods (20180216) will have added a few bytes. It only affects the fft16_lw benchmark, and the performance data for that has already been updated.
