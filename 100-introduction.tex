...
To illustrate this we will look at two concrete examples below.
...
However, one of the main design goals of Amulet is long battery life, and although the authors do not provide a breakdown of energy consumption per component like Mercury, they do note that "Energy consumption is significantly impacted by the fraction of time the application microcontroller (MSP430) is active". This suggests a large performance overhead would also significantly reduce battery lifetime.
...
The main research question of this dissertation is whether virtual machines are a suitable means to programme sensor node devices.
Specifically:
\begin{enumerate}
