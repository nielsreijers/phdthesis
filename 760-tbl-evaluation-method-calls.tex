...
\label{tbl-evaluation-method-calls}
    ...
    \begin{tabular}{lllllll} % UPDATED 20180305
    \toprule
    ...
    \\
    \mybench{CoreMark} \\
    ee\_isdigit                  & \multicolumn{1}{r}{3920}     & normal (inlined)  & manually inlined              & \tblhighlight lightweight (handw.) & manually inlined                \\
    ...
    \\
    \mybench{FFT} \\
    FIX\_MPY                     & \multicolumn{1}{r}{768}      & marked inline     & manually inlined              & \tblhighlight lightweight(handw.)  & \tblhighlight normal            \\
    \\
    %                                                                                 fft                             fft_lw                            fft_fn
